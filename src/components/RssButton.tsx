...
export function RssButton({ label, path }: { label: string; path: string }) {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-2 px-5 py-2 rounded-lg text-sm font-medium bg-slate-500/10 hover:bg-slate-500/20 transition-colors cursor-pointer border-none"
